defmodule Rumbl.VideoControllerTest do
  ...
  alias Rumbl.Video
  @valid_attrs %{url: "http://youtu.be", title: "vid", description: "a vid", view_count: 0}
  ...
  test "lists all user's videos on index", %{conn: conn, user: user} do
    user_video  = insert_video(user, %{title: "funny cats", url: "test.com", view_count: 1, description: "bla bla bla"})
    other_video = insert_video(insert_user(%{username: "other"}), %{title: "another video", url: "test.com", view_count: 1, description: "bla bla bla"})
